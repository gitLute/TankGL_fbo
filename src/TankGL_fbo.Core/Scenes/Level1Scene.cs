...
public sealed class Level1Scene : IScene
{
    ...
    public Level1Scene(Action<IScene>? requestSceneChange = null)
    {
    ...
    public void OnEnter()
    {
        ...
        _walls.Add(new Wall(new Vector2(150, -150), new Vector2(60, 20)));
        _walls.Add(new Wall(new Vector2(0, 0), new Vector2(40, 40)));
    ...
    {
        if (inputs.TryGetValue(0, out var actions) && actions.Contains(PlayerAction.Fire))
        {
